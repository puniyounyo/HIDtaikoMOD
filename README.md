...
| ピン番号 (Pro Micro) | シルク印刷  | SWモード用途 (推測) | PCモード用途 (推測) | 設定モード用途 (推測) |
|---|---|---|---|---|
| 17 | A0  | アナログセンサー (右) | アナログセンサー (右) | - (無効) |
| 18 | A1  | アナログセンサー (中央右) | アナログセンサー (中央右) | - (無効) |
| 19 | A2  | アナログセンサー (中央左) | アナログセンサー (中央左) | - (無効) |
| 20 | A3  | アナログセンサー (左) | アナログセンサー (左) | - (無効) |
| 7 | D4 | デジタル入力ボタン | デジタル入力ボタン | デジタル入力ボタン |
| 8 | D5 | デジタル入力ボタン | デジタル入力ボタン | デジタル入力ボタン |
| 9 | D6 | 設定値減少ボタン | 設定値減少ボタン | 設定値減少ボタン |
| 10 | D7 | 設定値増加ボタン | 設定値増加ボタン | 設定値増加ボタン |
| 11 | D8 | 設定決定ボタン | 設定決定ボタン | 設定決定ボタン |
| 12 | D9 | デジタル入力ボタン | デジタル入力ボタン | デジタル入力ボタン |
| 13 | D10  | デジタル入力ボタン | デジタル入力ボタン | デジタル入力ボタン |
| 14 | D16  | LED用データ出力 |
| 15 | D14  | 設定モード切り替え | 設定モード切り替え | 設定モード切り替え |
| 16 | D15  | SW/PCモード切替 (起動時判定) | SW/PCモード切替 (起動時判定) | SW/PCモード切替 (起動時判定) |
